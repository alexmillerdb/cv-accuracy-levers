"""Train and evaluate the sample-mode whole-image baseline."""
...
from levers.baseline import BaselineRunResult, run_sample_baseline
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--run-name", default="baseline_whole_image_sample")
...
def build_runtime_params(
    *,
    ...
    return {
        ...
        "lever_name": "baseline_whole_image",
...
def _set_mlflow_experiment(
    *,
    ...
    if resolved_tracking_uri.startswith("file:") and not experiment_id:
        mlflow.set_experiment(experiment_name or "cv-accuracy-levers-baseline")
        return
